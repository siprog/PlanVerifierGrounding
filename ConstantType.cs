...
namespace PlanValidation1
{
    ...
    class ConstantType
    {
        ...
        {
            if (this.Name == "any") return true; //INFO any is child to everything. This is used for constants with unknown types. We dont allow methdos that have unspecified type. As in we cannot have type all (unless user defined) 
